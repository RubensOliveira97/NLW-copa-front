...
import appPreviweImg from '../assets/app-nlw-copa-preview.png'
      ...
      <main>
        ...
        <div className='mt-10 flex items-center gap-2'>
          ...
          <strong className='text-gray-100 text-xl'>
            <span className='text-ignite-500'>+{props.userCount} pessoas</span> <span> já estão usando</span>
          </strong>
        </div>
        ...
        <div className='mt-10 pt-10 border-t border-gray-600 flex items-center justify-between text-gray-100'>
          ...
          <div className='w-px h-full bg-gray-600 h-14'></div>
